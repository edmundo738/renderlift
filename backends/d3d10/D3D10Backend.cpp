...
class D3D10Backend final:public IBackend {
  BackendStatus status_{};
public:
  GraphicsApi api()const override{return GraphicsApi::D3D10;}
  std::string_view name()const override{return "RenderLift.D3D10";}
